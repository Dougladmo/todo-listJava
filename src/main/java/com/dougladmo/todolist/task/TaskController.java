...
import com.dougladmo.todolist.utils.Utils;
...
public class TaskController {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity delete(@RequestBody TaskModel taskModel, @PathVariable UUID id, HttpServletRequest request) {
        var task = this.taskRepository.findById(id).orElse(null);
        ...
        return ResponseEntity.status(HttpStatus.OK).body("Tarefa apagada.");
    }
